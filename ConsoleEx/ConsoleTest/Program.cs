...
namespace ConsoleTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ConsoleEx.ScreenBuffer.SetBufferSize(80, 50);
            ...
            do
            {
                ...
                switch ((InputRecordType)Event.EventType)
                {
                    ...
                    case InputRecordType.KeyEvent:
                        ...
                        {
                            ConsoleEx.ScreenBuffer.Write(string.Format("'{3}' {0}:{1}-{2} {4}", Event.KeyEvent.VirtualKeyCode, Event.KeyEvent.VirtualScanCode, Event.KeyEvent.ControlKeyState.ToString(), Event.KeyEvent.Character, Event.KeyEvent.KeyDown));
                        }
                        break;
